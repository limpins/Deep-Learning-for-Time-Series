...
if __name__ == '__main__':
    # 设置参数
    cfg = get_json_data('configs/true_test.json')
    device = set_device()
    root = r'Data/'
    save_root = r'Data/true_test/'

    WGCI = get_person_WGCI(f'{root}Scenario1_sim15_K150012.mat', 'sim15_K1500', cfg)
    save_3Darray(f'{save_root}WGCI_true_test.txt', WGCI)
