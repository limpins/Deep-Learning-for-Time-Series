...
if flag == 1
    ...
    save('linear_signals_noise1.mat', 'linear_signals');
else
    % 不含噪音
    title('Linear Signals without noise');
    saveas(gcf, '../images/linear_signals_info_noise0.png');
    save('linear_signals_noise0.mat', 'linear_signals');
end
...
if flag == 1
    ...
    save('nonlinear_signals_noise1.mat', 'nonlinear_signals');
else
    % 不含噪音
    title('Nonlinear Signals without noise')
    saveas(gcf, '../images/nonlinear_signals_info_noise0.png')
    save('nonlinear_signals_noise0.mat', 'nonlinear_signals');
end
...
if flag == 1
    ...
    save('longlag_nonlinear_signals_noise1.mat', 'longlag_nonlinear_signals');
else
    % 不含噪音
